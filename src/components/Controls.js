    ...
    <>
      <div>
        <div className='w-full py-8  h-[125px] z-10  fixed bottom-0 bg-[rgba(29,33,35,0.3)] backdrop-blur-xl '>
          <div className='flex justify-between items-center px-[101px]'>
            <div className='flex items-center'>
              ...
              <div className='flex flex-col ml-[13px]'>
                <h6 className="text-[14px] font-bold text-white">{songslist[currentSong].artistName}</h6>

                <h6 className="text-[10px] font-bold text-[#EFEEE040]">{songslist[currentSong].title}</h6>
              </div>
            </div>
